...
def get_subject_preproc(subject,samplesize="83Perc"):
    foldername = "../0 Data/DB3/DB3_preproc_raw/{0}/{1}/".format(str(subject),samplesize)
...
with open("results_DB3_raw.csv","w") as wf:
...
for subject in range(1,12):
    ...
    #save model
    foldername = "./models/DB3_raw/model{}/".format(str(subject))
    os.mkdir(foldername) 
    ...
    for retraining_samples in ["83Perc","60Perc", "30Perc","16Perc","fiveMovements","oneMovement"]:
        ...
        for retraining_method in ["all","first", "last","first_last","new"]:    
            ...
            with open("results_DB3_raw.csv","a") as wf:
