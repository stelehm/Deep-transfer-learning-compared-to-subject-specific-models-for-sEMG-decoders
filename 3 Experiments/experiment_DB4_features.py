...
def get_subject_preproc(subject,samplesize="83Perc"):
    foldername = "../0 Data/DB4/DB4_preproc_Features/{0}/{1}/".format(str(subject),samplesize)
...
with open("results_DB4_features.csv","w") as wf:
...
for subject in range(1,11):
    ...
    #save model
    foldername = "./models/DB4_features/model{}/".format(str(subject))
    os.mkdir(foldername) 
    ...
    for retraining_samples in ["83Perc","60Perc", "30Perc","16Perc","fiveMovements","oneMovement"]:
        ...
        for retraining_method in ["all","first", "last","first_last","new"]:    
            ...
            with open("results_DB4_features.csv","a") as wf:
