...
def get_subject_preproc(subject,samplesize="83Perc"):
    foldername = "../0 Data/DB2/DB2_preproc_raw/{0}/{1}/".format(str(subject),samplesize)
...
with open("results_DB2_raw.csv","w") as wf:
...
for subject in range(11,41):
    ...
    #save model
    foldername = "./models/DB2_raw/model{}/".format(str(subject))
    os.mkdir(foldername) 
    ...
    for retraining_samples in ["83Perc","60Perc", "30Perc","16Perc","fiveMovements","oneMovement"]:
        ...
        for retraining_method in ["all","first", "last","first_last","new"]:    
            ...
            with open("results_DB2_raw.csv","a") as wf:
